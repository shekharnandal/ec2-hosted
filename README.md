...
http://YOUR_PUBLIC_IP
```
### tpye the following code to enter your own data
```bash
cd /var/www/html
sudo rm index.html
sudo vi index.html
...
after that commands press i the entre your own data
the press ctrl + c and type n":wq" to exit form it
...
### You should see the your website Welcome Page.
